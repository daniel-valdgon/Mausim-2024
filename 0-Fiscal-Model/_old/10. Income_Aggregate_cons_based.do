...
merge 1:1 hhid using "${tempsim}/DirTransfers" , nogen
...
merge 1:1 hhid using `DirTransfers' , nogen
...
gen ymp_pc=yd_pre
	...
	local DirectTransfers   "am_bourse am_Cantine am_BNSF am_subCMU UBI pub_student_transfer " /*rev_pubstu rev_universel*/
