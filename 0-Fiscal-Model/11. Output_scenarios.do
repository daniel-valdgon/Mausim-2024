...
// This locals are different from those in dofile 1, please check that they contain what's needed. 	
	...
	local tax dirtax_total `Directaxes'
	local indtax indtax_total `Indtaxes'
	local inkind inktransf_total `InKindTransfers'
	local transfer dirtransf_total `DirectTransfers'
	local subsidies subsidy_total `Subsidies'
