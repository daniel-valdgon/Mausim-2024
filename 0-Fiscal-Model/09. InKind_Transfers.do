...
keep hhid ben_pre_school ben_primary ben_secondary ben_tertiary 

global Edu_montantPrescolaire 8200
global Edu_montantPrimaire 3400
global Edu_montantSecondaireLow 2090
global Edu_montantSecondaire 1130
global Edu_montantSuperieur 49850

gen am_pre_school_pub = ${Edu_montantPrescolaire}  if ben_pre_school==1  
gen am_primary_pub    = ${Edu_montantPrimaire}     if ben_primary==1     
gen am_secondary_low_pub  = ${Edu_montantSecondaireLow}   if ben_secondary==1 
gen am_secondary_pub  = ${Edu_montantSecondaire}   if ben_secondary==1 
gen am_tertiary_pub   = ${Edu_montantSuperieur}    if ben_tertiary==1  
 
collapse (sum)  am_pre_school_pub am_primary_pub am_secondary_pub am_secondary_low_pub am_tertiary_pub, by(hhid)

egen education_inKind=rowtotal(am_pre_school_pub am_primary_pub am_secondary_low_pub am_secondary_pub am_tertiary_pub)
