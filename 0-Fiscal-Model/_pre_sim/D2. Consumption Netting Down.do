...
egen subsidy_fuel_SY = rowtotal(sub_gasoline sub_gasoil sub_lpg)
...
gen achats_net_cd = achats_net_excise / ( 1 +  (1 - informal_purchase) * (1 + CD_imp))
...
sum hhid codpr hhsize sector pourcentage pondera_informal informal_purchase depan achat_gross achats_net_VAT achats_net_excise achats_net_subind achats_net_sub achats_net achats_net_cd


keep hhid codpr informal_purchase hhsize sector pourcentage achat_gross achats_net_VAT achats_net_excise achats_net_subind achats_net_sub achats_net achats_net_cd
