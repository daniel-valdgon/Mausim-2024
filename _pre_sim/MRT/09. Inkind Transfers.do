...
* Agglomerations
import delimited "$data_sn/QGis/Agglomerations.csv", clear
...
* Health institutions
import delimited "$data_sn/QGis/Health.csv", clear
...
* Matrix distances
import delimited "$data_sn/QGis/Distances.csv", clear
