...
if "`c(username)'"=="gabriellombomoreno" {
	...
	global report 		"${path}/04. Reports/8. Specials/EU SPJ"
	...
	* Set Parameters
	...
	global proj_1		"MRT_Ref_2024_sim5" 
	global proj_2		"MRT_Ref_2024_sim6"
	global proj_3		""  
	global proj_4		""
	global proj_5		""
...
/*-------------------------------------------------------/
	2. Relative Incidence among beneficiaries
/-------------------------------------------------------*/
...
export excel "$xls_out", sheet(Rel_Incidence2) first(variable) sheetmodify cell(A1)
